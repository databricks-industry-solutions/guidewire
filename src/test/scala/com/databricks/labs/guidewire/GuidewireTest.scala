...
//    val confB = new SerializableWritable(conf)
//    println(confB.value)
//  }
//
//
...
////    List.fill(10)(0.0).zipWithIndex.toDF("a", "b").repartition(1)
////      .write
////      .format("delta")
////      .save("delta_oss")
////
...
////      .save("delta_oss")
////
////    List.fill(10)(0.0).zipWithIndex.map(i => (i._1, i._2, 12)).toDF("a", "b", "c").repartition(1)
////      .write
////      .mode("overwrite")
